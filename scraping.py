...
browser = webdriver.Chrome(executable_path=r"/Users/kush/Desktop/Web Scraping/chromedriver")
browser.get(start_url)
time.sleep(10)
header = ["Name","Light-Years From Earth","Planet Mass","Stellar Magnitude","Discovery Date","Planet Type","Discovery Date","Mass","Planet Radius","Orbital Radius","Orbital Period","Eccentricity","Direction Method"]
planet_data = []
new_planet_data = []
def func():
                ...
                for f,r in enumerate(li):
                    if f==0:
                        ...
                        try:
                            ...
                            el.append("")
                l = li[0]
                el.append("https://exoplanets.nasa.gov"+l.find_all("a",href=True)[0]["href"])
